      ...
      <div class="row mx-auto d-flex flex-column gap-5" style="width:80%">
        <div class="d-flex flex-column justify-content-center align-items-center">
          ...
          <p style="color:white;text-align:center">
            Queremos solucionar de manera eficaz el inconveniente. Puedes
            escribirnos al Whatsapp para brindarte una solución más rápida
          </p>
          <div class="btn-blue">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
          <p style="color:white;text-align:center">
            En caso decida continuar con el registro en el libro de
            reclamaciones, se le precisa que es su responsabilidad indicar de
            forma correcta la unidad prestadora del servicio, para una rápida
